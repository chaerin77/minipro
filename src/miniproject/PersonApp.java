        ...
        while(true) { //스위치(1~5) 반복문
		    ...
		    case 1:
		    	...
		    	*/
		    	...
		    	if(pList.size() != 0) {
			    	for(int i=0-pList.size(); i<pList.size()+i; i++) {//ArrayList 삭제 되었을때 특징이용
			    		pList.remove(0);
			    	}
		    	}
		    ...
		    case 2:
		        ...
		        for(int i=0; i<pList.size(); i++) {
		            ...
		            */
		        	String addLine = pList.get(i).addinfo();//Form에 정의한 메소드 사용
		        	addbw.write(addLine);
		            addbw.newLine();
		        }
		    ...
		    case 3:
		    	...
		    	System.out.print(">번호 : ");
		    	/*또 읽어오지 않아도 pList 자체는 공유되는중이라 안읽어오기로 함
